//-----------------------------------------------------------------------------
//
// Desc: Matchmaking classs for Tsunami Integrated Sample (ID 0xffedaaab)
...
VOID CSession::SetupAttributes()
{
    ...
    ZeroMemory( &m_blobConfigInfo, XATTRIB_CONFIG_INFO_MAX_LEN );
    m_Attributes[CONFIG_INFO_INDEX].info.blob.pvValue = m_blobConfigInfo;
}
...
{
    return CBlob( (WORD) m_Attributes[CONFIG_INFO_INDEX].info.blob.dwLength, m_blobConfigInfo );
}
...
VOID  CSession::SetConfigInfo( CBlob Value )
{
    ...
    memcpy( m_blobConfigInfo, Value.Data, Value.Length );
...
XONLINE_ATTRIBUTE_SPEC OptiMatchAttributeSpec[]=
{
    ...
    { X_ATTRIBUTE_DATATYPE_STRING, ( XATTRIB_OWNER_NAME_MAX_LEN + 1 ) * sizeof( WCHAR ) }, // OwnerName
                  ...
                  )
{
    ...
    QueryParameters[1].dwAttributeID = ( PlayerLevel == X_MATCH_NULL_INTEGER ) ? X_ATTRIBUTE_DATATYPE_NULL : X_ATTRIBUTE_DATATYPE_INTEGER;
    QueryParameters[1].info.integer.qwValue = PlayerLevel;
    QueryParameters[2].dwAttributeID = ( GameStyle == X_MATCH_NULL_INTEGER ) ? X_ATTRIBUTE_DATATYPE_NULL : X_ATTRIBUTE_DATATYPE_INTEGER;

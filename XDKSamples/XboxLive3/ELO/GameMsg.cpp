...
{
    m_pApp->OnJoinApproved( hostInfo );
}
...
{
    m_pApp->OnJoinApprovedAddPlayer( playerInfo );
}
...
{
    m_pApp->OnPlayerJoined( playerInfo );
}
...
// Desc: The given player waved to us
//-------------------------------------------------------------------------------------
VOID GameMsg::OnBlob( const CXBNetPlayerInfo& playerInfo, const CXBNetBlob& blob )
{
    m_pApp->OnBlob( playerInfo, blob );
}
...
{
    m_pApp->OnPlayerDropout( playerInfo, bIsHost );
}

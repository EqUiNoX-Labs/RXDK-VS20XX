...
//       03.14.01 - Meta data updates for April XDK release
...
private:
    ...
    VOID DrawButton( FLOAT fX, const WCHAR* ) const;
    VOID DrawMsgBox( const D3DXVECTOR4&, const WCHAR*, CXBFont&, DWORD ) const;
    VOID RenderTile( const D3DXVECTOR4&, const LPDIRECT3DTEXTURE8, DWORD dwColor,
                     BOOL = FALSE ) const;

...
HRESULT CXBoxSample::Initialize()
{
    ...
    // NOTE: THIS IS VERY IMPORTANT. After loading vertex shaders into memory with
    ...
    if( FAILED( XBUtil_CreateVertexShader( "Shaders\\Shader1.xvu", 
    ...
    if( FAILED( XBUtil_CreateVertexShader( "Shaders\\Shader2.xvu", 
    ...
    if( FAILED( XBUtil_CreateVertexShader( "Shaders\\Shader3.xvu", 
...
HRESULT CXBoxSample::Render()
{
    ...
    RenderGradientBackground( 0xff404040, 0xff000000 ); 
    ...
    else
    {
        ...
        m_Font.DrawText( 48, 36, 0xffffffff,  L"MultiShader" );

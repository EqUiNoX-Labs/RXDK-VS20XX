...
HRESULT CXBoxSample::Initialize()
{
    ...
    if( FAILED(XBUtil_CreateVertexShader( "Shaders\\VertShdr.xvu", 
    ...
    if(FAILED(XBUtil_CreateVertexShader( "Shaders\\MatInv.xvu", 
...
HRESULT CXBoxSample::Render()
{
    ...
    m_Font.DrawText( 48, 36, 0xffffffff,  L"StateShader" );

...
// Desc: Tiles (or untiles) and compresses (or decompresses) the primary
...
// Desc: Tiles (or untiles) and compresses (or decompresses) the secondary
...
HRESULT CXBoxSample::Render()
{
    ...
    else
    {
        ...
        m_Font16.DrawText( 62, 45, 0xffffffff,  L"Tiling" );
        m_Font16.SetScaleFactors( 1.0f, 1.0f );
        m_Font16.DrawText( 568, 48, 0xffffff00, m_strFrameRate, XBFONT_RIGHT );
        m_Font16.End();

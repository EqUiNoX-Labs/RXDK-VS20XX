...
//       rendering subsets, and also support for hierarchal transformations.
//
//       A real Xbox game will likely use a custom format, but should still have
//       a number of similarities to the .XBG format...most notably that any
...
DWORD                   g_dwNumMeshFrames     = 0L;   // Hierarchy of frames for the mesh

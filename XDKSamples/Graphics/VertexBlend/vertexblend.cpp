...
HRESULT CXBoxSample::Initialize()
{
    ...
    if( FAILED( m_pObject->Create( "Models\\MSLogo.xbg" ) ) )
        return XBAPPERR_MEDIANOTFOUND;
    ...
    if( FAILED( XBUtil_CreateVertexShader( "Shaders\\Blend.xvu", 
...
HRESULT CXBoxSample::Render()
{
    ...
    else
    {
        ...
        m_Font.DrawText( 48, 36, 0xffffffff,  L"VertexBlend" );

...
HRESULT CXBoxSample::Initialize()
{
    ...
    if( FAILED( m_Airplane.Create( "Models\\Airplane.xbg", &m_xprResource ) ) )
        return XBAPPERR_MEDIANOTFOUND;

    // Load some terrain
    if( FAILED( m_Terrain.Create( "Models\\SeaFloor.xbg", &m_xprResource ) ) )
        return XBAPPERR_MEDIANOTFOUND;
    ...
    // Tweak the terrain vertices to add some bumpy terrain
    {
        ...
        for( DWORD i=0; i<dwNumVertices; i++ )
        {
            ...
            D3DXVECTOR3 n;
            const D3DXVECTOR3 v01v00( v01 - v00 );
            const D3DXVECTOR3 v10v00( v10 - v00 );
            D3DXVec3Cross( &n, &v01v00, &v10v00 );
...
HRESULT CXBoxSample::Render()
{
    ...
    m_Font.DrawText( 48, 36, 0xffffffff,  L"StencilMirror" );

...
class CXBoxSample : public CXBApplication
{
    ...
    LPDIRECT3DVERTEXBUFFER8 m_pVB;    // Object to use for two-sided lighting
...
HRESULT CXBoxSample::Initialize()
{
    ...
    if( FAILED( XBUtil_CreateVertexShader( "Shaders\\TwoSided.xvu", 
...
HRESULT CXBoxSample::Render()
{
    ...
    else
    {
        ...
        m_Font.DrawText( 48, 36, 0xffffffff,  L"TwoSidedLighting" );

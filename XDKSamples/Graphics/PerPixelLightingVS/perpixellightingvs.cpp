...
//
// Desc: Example code showing how to do per-pixel lighting using vertex shaders.ers.
//
...
HRESULT CXBoxSample::Render()
{
    ...
    else
    {
        ...
        m_Font.DrawText( 48, 36, 0xffffffff,  L"PerPixelLightingVS" );
                            ...
                            CXBPackedResource* pResource )
{
    ...
    if( FAILED( XBUtil_CreateVertexShader( "Shaders\\PPLight.xvu",
                                           dwVertexDecl,
                                           &m_dwVertexShader ) ) )
        return XBAPPERR_MEDIANOTFOUND;

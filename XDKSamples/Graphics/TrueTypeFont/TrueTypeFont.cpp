...
XBHELP_CALLOUT g_HelpCallouts[] = 
{
    ...
    { XBHELP_A_BUTTON,    XBHELP_PLACEMENT_2, L"Change font\nstyle" },
};
...
HRESULT CXBoxSample::Initialize()
{
    ...
    // renders MUCH more quickly.  If it's smaller then file size, the cache holds
...
HRESULT CXBoxSample::Render()
{
    ...
    switch (m_dwFontDrawStyle)
    {
        case FONT_DRAW_STYLE_1:
        {
            ...
            m_pDefaultTrueTypeFont->TextOut( pFrontBuffer, 
                                           L"This is the Default Arial 24 Pixel Font", (unsigned)-1, 60, 100 );
        }
        break;
        ...
        case FONT_DRAW_STYLE_2:
        {
            ...
            m_pArialTrueTypeFont->TextOut( pFrontBuffer, 
                                            L"This is Arial True Type 20 Pixel Normal", (unsigned)-1, 60, 100 );
        }
        break;
        ...
        case FONT_DRAW_STYLE_6:
        {
            ...
            m_pKanji16BitmapFont->TextOut( pFrontBuffer,
                                           m_pKanjiMessage, (unsigned)-1, 60, 140 );
        }
        break;
    }
    ...
    else
    {
        ...
        m_Font.DrawText( 48, 36, 0xffffffff,  L"TrueTypeFont" );

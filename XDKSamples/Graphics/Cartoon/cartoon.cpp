...
//-----------------------------------------------------------------------------
BOOL CXBCartoonMesh::RenderCallback( DWORD dwSubset, XBMESH_SUBSET* pSubset,
                                     DWORD dwFlags )
{
    ...
    D3DDevice::SetVertexShaderConstant( 4, &matAll, 4 );
    D3DDevice::SetVertexShaderConstant( 8, &matWorld, 4 );
...
HRESULT CXBoxSample::Initialize()
{
    ...
    if( FAILED( m_Mesh.Create( "Models\\Robot.xbg" ) ) )
        return XBAPPERR_MEDIANOTFOUND;
    ...
    if( FAILED( XBUtil_CreateVertexShader( "Shaders\\Cartoon.xvu",
                                           dwCartoonVertexDecl,
...
HRESULT CXBoxSample::FrameMove()
{
    ...
    D3DXVECTOR3 vRotLight( 0.3487f, 0.1162f, -0.9300f );
...
HRESULT CXBoxSample::Render()
{
    ...
    // Draw the geometry
    m_Mesh.Render( XBMESH_NOMATERIALS | XBMESH_NOTEXTURES );
    ...
    else
    {
        ...
        m_Font.DrawText( 48, 36, 0xffffffff,  L"Cartoon" );

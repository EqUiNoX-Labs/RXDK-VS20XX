...
HRESULT CXBoxSample::Initialize()
{
    ...
    // Set the view matrix
    const D3DXVECTOR3 vEyePos( 0.0f, 0.0f,-15.0f );
...
VOID CXBoxSample::CalculateTexProjMatrix()
{
    ...
    D3DXMatrixLookAtLH( &matTexView, &m_vTexEyePt, &m_vTexLookatPt, &vUp );
...
HRESULT CXBoxSample::Render()
{
    ...
    // Draw texture projection frustum
    if( m_bDrawFrustrum )
    {
    ...
    else
    {
        ...
        m_Font.DrawText( 48, 36, 0xffffffff,  L"ProjectedTexture" );

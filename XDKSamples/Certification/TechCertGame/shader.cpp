...
VOID ShaderTexturedBump::InitShaders()
{
    ...
    DWORD dwBumpVertexShaderDecl[] =
    {
        ...
        D3DVSD_REG( 2, D3DVSDT_FLOAT2 ), // v2 = texture coordinate
    ...
    hr = XBUtil_CreateVertexShader( "Shaders\\BumpMap.xvu",
    ...
    hr = XBUtil_CreateVertexShader( "Shaders\\ImageMap.xvu",
    ...
    hr = XBUtil_CreateNormalizationCubeMap( 64, &m_pNormalizationCubemap );
    assert(hr == D3D_OK);

...
XBHELP_CALLOUT g_HelpCallouts[] = 
{
    ...
    { XBHELP_A_BUTTON,     XBHELP_PLACEMENT_2, L"Sound\neffect #1" },
    { XBHELP_X_BUTTON,     XBHELP_PLACEMENT_2, L"Sound\neffect #2" },
};
...
HRESULT InitDirectMusic() 
{
    ...
    // Initialize the performance with the standard audiopath.
    ...
    // Play segment on the default audiopath
...
//-----------------------------------------------------------------------------
// Name: FrameMove()
// Desc: Performs any per-frame updates necessary
//-----------------------------------------------------------------------------
...
HRESULT CXBoxSample::Render()
{
    ...
    else
    {
        ...
        m_Font.DrawText( 48, 36, 0xffffffff, L"DMGrooveLevel" );
        m_Font.SetScaleFactors( 1.0f, 1.0f );

        m_Font.DrawText( 80, 100, 0xffffff00, L"Volume:" );
        {
            struct BACKGROUNDVERTEX { D3DXVECTOR4 p; D3DCOLOR color; };
            BACKGROUNDVERTEX v[4];
            FLOAT x1 = 230, x2 = x1 + (340*m_fVolume)/100;
            FLOAT y1 = 102, y2 = y1 + 20;
            ...
            v[2].p = D3DXVECTOR4( x2-0.5f, y2-0.5f, 1.0f, 1.0f );  v[2].color = 0xffff0000;
            v[3].p = D3DXVECTOR4( x1-0.5f, y2-0.5f, 1.0f, 1.0f );  v[3].color = 0xffff0000;
        ...
        m_Font.DrawText( 80, 150, 0xffffff00, L"Groove Level:" );
        {
            struct BACKGROUNDVERTEX { D3DXVECTOR4 p; D3DCOLOR color; };
            BACKGROUNDVERTEX v[4];
            FLOAT x1 = 230, x2 = x1 + (340*m_fGrooveLevel)/100;
            FLOAT y1 = 152, y2 = y1 + 20;
            v[0].p = D3DXVECTOR4( x1-0.5f, y1-0.5f, 1.0f, 1.0f );  v[0].color = 0xffffffff;
            v[1].p = D3DXVECTOR4( x2-0.5f, y1-0.5f, 1.0f, 1.0f );  v[1].color = 0xffffffff;
            v[2].p = D3DXVECTOR4( x2-0.5f, y2-0.5f, 1.0f, 1.0f );  v[2].color = 0xff00ff00;
            v[3].p = D3DXVECTOR4( x1-0.5f, y2-0.5f, 1.0f, 1.0f );  v[3].color = 0xff00ff00;
        ...
        m_Font.DrawText( 592, 420, 0xffffffff, L"Help" GLYPH_BACK1_BUTTON GLYPH_BACK2_BUTTON, XBFONT_RIGHT );
